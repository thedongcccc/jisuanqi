...
protected:
    ...
    QPushButton *button_kong;
    QPushButton *button_1y1c;
    QPushButton *button_1y2c;
    QPushButton *button_fbl;
...
private slots:
    ...
    void button_kong_clicked();
    void button_1y1c_clicked();
    void button_1y2c_clicked();
    void button_fbl_clicked();
