...
void MainWindow::myLayout(){
    ...
    button_kong = new QPushButton("空格");
    button_1y1c = new QPushButton("一元一次");
    button_1y2c = new QPushButton("一元二次");
    button_fbl = new QPushButton("反比例");
    ...
    connect(button_kong,SIGNAL(clicked(bool)),this,SLOT(button_kong_clicked()));
    connect(button_1y1c,SIGNAL(clicked(bool)),this,SLOT(button_1y1c_clicked()));
    connect(button_1y2c,SIGNAL(clicked(bool)),this,SLOT(button_1y2c_clicked()));
    connect(button_fbl,SIGNAL(clicked(bool)),this,SLOT(button_fbl_clicked()));
    ...
    button_kong->setMinimumHeight(50);
    button_1y1c->setMinimumHeight(50);
    button_1y2c->setMinimumHeight(50);
    button_fbl->setMinimumHeight(50);
    ...
    layout->addWidget(button_f,5,6,Qt::Alignment());
    ...
    layout->addWidget(button_kong,3,6,Qt::Alignment());
    ...
    layout->addWidget(button_gongyueshu,6,5,Qt::Alignment());
    layout->addWidget(button_gongbeishu,6,6,Qt::Alignment());
    ...
    layout->addWidget(button_1y1c,7,5,Qt::Alignment());
    layout->addWidget(button_1y2c,7,6,Qt::Alignment());
    layout->addWidget(button_fbl,8,6,Qt::Alignment());
...
void MainWindow::button_fbl_clicked(){
    j=1;
    s2+="y=u/x";
    data->setText(s2);
    s2+=" u=";
}
void MainWindow::button_1y2c_clicked(){
    k=1;
    s2+="y=ux^2+vx+w";
    data->setText(s2);
    s2+=" u=";
}
void MainWindow::button_1y1c_clicked(){
    t=1;
    s2+="y=ux+v";
    data->setText(s2);
    s2+=" u=";
...
void MainWindow::button_kong_clicked(){
    if(j==1){
        bool ok=true;
        u=s1.toDouble(&ok);
        j=2;
...
void MainWindow::button_result_clicked(){
    if(j==2){
        ...
        Y=u/X;
        QString c="";
        c= QString::number(Y,format='g',precision=6);
        s3+="y=";
        s3+=c;
        data1->setText(s3);
        s3+=" ";
